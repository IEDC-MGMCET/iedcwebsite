...
export const execomMembers: ExecomMember[] = [
  ...
  { id: '1', name: 'Adarsh Antony', role: 'Chief Executive Officer (CEO)', image: 'AdarshAntony', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '2', name: 'Shamilin Shaji', role: 'Chief Operations Officer (COO)', image: 'ShamilinShaji', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '3', name: 'Aiswarya Bijulal', role: 'Chief Technical Officer (CTO)', image: 'AiswaryaBijulal', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '4', name: 'Anagha PS', role: 'Chief Creative Officer (CCO)', image: 'AnaghaPS', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '5', name: 'Pavithra KA', role: 'Chief Finance Officer (CFO)', image: 'PavithraKA', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '6', name: 'Shaun S Sooraj', role: 'Chief Marketing Officer (CMO)', image: 'ShaunSSooraj', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '7', name: 'Salman A', role: 'Community Lead', image: 'SalmanA', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '8', name: 'Sana Meharin K', role: 'Women Entrepreneurship Lead', image: 'SanaMeharinK', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '9', name: 'Kelbin Bijoy C', role: 'Associate OO', image: 'KelbinBijoyC', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '10', name: 'Aswin CS', role: 'Associate TO', image: 'AswinCS', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '11', name: 'Aswananda Babu', role: 'Associate FO', image: 'AswanandaBabu', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '12', name: 'Abhijith AR', role: 'Associate CO', image: 'AbhijithAR', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },
  { id: '13', name: 'Jilna Johnson', role: 'Associate Community Lead', image: 'JilnaJohnson', year: '26-27', isCurrent: true, linkedin: '#', github: '#' },

  { id: '14', name: 'Ananya Suresh', role: 'President', image: 'AnanyaSuresh', year: '25-26', isCurrent: false, linkedin: '#', github: '#' },
  { id: '15', name: 'Vishnu Mohan', role: 'Tech Lead', image: 'VishnuMohan', year: '25-26', isCurrent: false, linkedin: '#', github: '#' },
  { id: '16', name: 'Lakshmi Pillai', role: 'Design Head', image: 'LakshmiPillai', year: '25-26', isCurrent: false, linkedin: '#', github: '#' },
  { id: '17', name: 'Arjun Varma', role: 'Events Lead', image: 'ArjunVarma', year: '25-26', isCurrent: false, linkedin: '#', github: '#' },
]
