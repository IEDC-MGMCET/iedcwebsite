          ...
          {pastYears.map(year => {
            ...
            return (
              <div key={year} style={{ marginBottom: '4rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                  <div style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '1.4rem', color: 'var(--gold)', letterSpacing: '0.06em', lineHeight: 1 }}>
                    {year}
                  </div>
                ...
                <div className="past-execom-grid">
                  {batch.map(m => (
                    <div
                      ...
                      onMouseEnter={e => { const t = e.currentTarget; t.style.boxShadow = '0 8px 30px rgba(0,0,0,0.08)'; t.style.borderColor = 'rgba(201,162,39,0.3)' }}
                      onMouseLeave={e => { const t = e.currentTarget; t.style.boxShadow = ''; t.style.borderColor = 'rgba(0,0,0,0.07)' }}
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: '0.82rem', color: 'var(--text)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                          {m.name}
                        </div>
                        <div style={{ fontFamily: '"DM Mono", monospace', fontSize: '0.52rem', letterSpacing: '0.1em', color: 'var(--muted-light)', textTransform: 'uppercase', marginTop: '0.2rem', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                          {m.role}
                        </div>
                      </div>
